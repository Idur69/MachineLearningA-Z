# -*- coding: utf-8 -*-
"""
Created on Mon Dec  2 22:27:49 2019
...
# Spliting the dataset into Training set and Test
...
# Fiting Decision Tree Classifier to Training set
...
plt.contourf(X1, X2, classifier.predict(np.array([X1.ravel(), X2.ravel()]).T).reshape(X1.shape),
             aplph = 0.75, cmap = ListedColormap(("red", "green")))
